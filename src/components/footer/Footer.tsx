      ...
      <div className="container">
        ...
        <div className="mt-12 md:mt-48">
          <p className="text-zinc-400">
            &copy; 2024 tushar upadhyay .All rights reserved
          </p>

          <div className="mt-4 md:mt-0 flex gap-6">
            {soicalIcons.map((item, index) => {
              return (
                <a
                  key={index}
                  href={item.href}
                  ...
                  className="inline-flex size-10 bg-zinc-800 rounded-full items-center justify-center hover:bg-zinc-700 transition"
                >
                  {item.icon}
                </a>
              );
